...
const CheckoutInfoModal = dynamic(
  () => import("@/components/orders/CheckoutInfoModal"),
  { ssr: false }
);
...
export default function CheckoutForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!emailInput) newErrors.email = "Įveskite el. pašto adresą";
    ...
    const deliveryDateInput = selectedDate
      ? selectedDate.toISOString().split("T")[0]
      : "";
    const deliveryTimeInput = selectedTime
      ? selectedTime.toTimeString().split(" ")[0].substring(0, 5)
      : "";
    ...
    const formData = {
      ...
      address:
        deliveryType === "pristatymas"
          ...
          : undefined,
      deliveryDate:
        orderType === "isankstinis" && (deliveryDateInput || deliveryTimeInput)
  ...
  return (
    <section
      className={`max-w-4xl mx-auto p-6 bg-[#FAF4EC] shadow-custom rounded-lg my-10 transition-transform duration-500 ${
    ...
    >
      ...
      <h2 className=" font-bold text-brown mb-6 text-l md:text-xl">
        Kontaktinė forma
      </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <UniversalInput name="surname" value={surname} onChange={() => {}} h />
        ...
        {orderType === "isankstinis" && (
          <div className="pb-6 border-b border-orange-200 text-sm md:text-base">
            <label className="block text-brown mb-1">
              Pageidaujama pristatymo data ir laikas
            </label>
        ...
        <div className="pb-6 border-b border-orange-200 text-sm md:text-base">
          <RadioGroup
            ...
            options={[
              {
                value: "atsiimti",
                label: "Atsiėmimas Vilniuje, Ūmedžių g. 10-2",
              },
